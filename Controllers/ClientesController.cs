...
namespace TrabalhoFinalAcademiaNet.Controllers
{
    public class ClientesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,NomeCliente,Cnpj,Endereco,Email,Telefone")] Cliente cliente)
        {
            if (ModelState.IsValid)
            {
                if (string.IsNullOrEmpty(cliente.NomeCliente) || string.IsNullOrEmpty(cliente.Cnpj) || string.IsNullOrEmpty(cliente.Endereco) || string.IsNullOrEmpty(cliente.Email) || string.IsNullOrEmpty(cliente.Telefone))
                {
