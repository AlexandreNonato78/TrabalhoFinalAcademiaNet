...
namespace TrabalhoFinalAcademiaNet.Models
{
    public class Venda
    {
        internal readonly object Entregas;
        ...
        public ICollection<Entrega> Entrega { get; set; } // Coleção de Entregas associadas à Venda

        // Construtor para inicializar a coleção, se necessário
        public Venda()
        {
